...
<div class="container">
    ...
    <form:form action="${action}" modelAttribute="khuyenMai" >
        ...
        <div class="mb-3">
            ...
            <form:errors path="createDate" cssStyle="color: crimson"/>
        </div>
        <div class="mb-3">
            <label class="form-label">LastModifiledDate</label>
            <form:input path="lastModifiledDate" class="form-control"/>
            <form:errors path="lastModifiledDate" cssStyle="color: crimson"/>
        </div>
        <div class="mb-3">
